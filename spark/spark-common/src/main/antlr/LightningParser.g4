...
registerDataSource
    : REGISTER (OR REPLACE)? dataSourceType = (JDBC | ICEBERG | ORC | PARQUET | DELTA | AVRO | CSV | XML | JSON | PDF | IMAGE | VIDEO | AUDIO)
...
nonReserved
    : ACTION | ARRAY  | ARRAY | AVRO | BUILD | CSV | DATASOURCE | DAY | DELTA | EXISTS  | HOUR |
    | ICEBERG | INTERVAL | JDBC | JSON | LAKEHOUSE | MAP | MINUTE | MONTH | NO | OPTIONS
